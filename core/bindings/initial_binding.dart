...
import '../services/child_live_location_service.dart';
...
import '../../features/ai_chat/services/ai_chat_assistant_service.dart';
import '../../features/community/services/community_group_ai_suggestion_service.dart';
...
class InitialBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.put(
      FavoritesRepository(Get.find<FirestoreService>().firestore),
      permanent: true,
    );
    Get.put(
      ReviewsRepository(Get.find<FirestoreService>().firestore),
      permanent: true,
    );

    // =============== Services (Dependent)
    Get.put(ChildLiveLocationService(), permanent: true);
    Get.put(AiChatAssistantService(), permanent: true);
    Get.put(CommunityGroupAiSuggestionService(), permanent: true);
